<?php
  ...
  if(mysqli_connect_errno($conn)){
    ...
    mysqli_select_db($conn, "illegal_parking");
    ...
    //$sql = "INSERT INTO illegal_tb (car_num, location, times)
    //  VALUES ('{$cn[0].$cn[1].$cn1[mt_rand(0,8)].$cn[2].$cn[3].$cn[4].$cn[5]}', '부산시 {$lo1[mt_rand(0,7)].$lo2[mt_rand(0,9)]}', now())";
    $sql = "INSERT INTO illegal_tb (car_num, location, times)
      VALUES ('$cn[$randcn1]$cn[$randcn2]$cn1[$randcns1]$cn[$randcn3]$cn[$randcn4]$cn[$randcn5]$cn[$randcn6]',
