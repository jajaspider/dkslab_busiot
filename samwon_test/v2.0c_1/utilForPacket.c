...
//OBD-II
	...
	dst->driverCode									= src->driverCode;
	dst->busDirection								=	src->busDirection;
	dst->busCntTime									= src->busCntTime;
...
int32_t MoveGpsData_sensor2value (SensorDataValue *_output_sensorDataValue) {
	static double divisionToRandmax = 1.0 / RAND_MAX;
	...
	_output_sensorDataValue->gpsX = 35.2222690 + rand()*divisionToRandmax * 0.0002575;
	_output_sensorDataValue->gpsY = 129.118868 + rand()*divisionToRandmax * 0.0002575;
...
int32_t MoveOBD2Data_sensor2value (SensorDataValue *_output_sensorDataValue) {
	...
	_output_sensorDataValue->driverCode = 0x12345678;

	_output_sensorDataValue->busDirection = 1;
	
	_output_sensorDataValue->busCntTime = 1;
	...
	//_output_sensorDataValue->busInnerOxygen[0] = 3.3f;
	_output_sensorDataValue->busInnerOxygen[1] = (BYTE) read_pcf8591_for_gas (&tmp)  * _100_DIV_128_ - 100;


	_output_sensorDataValue->runTimeToEngineStart		= 12345;
...
int32_t MoveWildDrivingData_sensor2value (SensorDataValue *_output_sensorDataValue) {
	...
	adxl345_read_xyz_0to1(fd,
	&_output_sensorDataValue->gSensorX[0], &_output_sensorDataValue->gSensorX[1],
	&_output_sensorDataValue->gSensorY[0], &_output_sensorDataValue->gSensorY[1],
	&_output_sensorDataValue->gSensorZ[0], &_output_sensorDataValue->gSensorZ[1]);
...
int32_t MoveHygrothermalData_sensor2value (SensorDataValue *_output_sensorDataValue) {
	...
	_output_sensorDataValue->thermometerTemperature = dht11_data[0];
	_output_sensorDataValue->hygrometerHumidity = dht11_data[2];
	#endif
...
int32_t MoveDisabledPersonResvData_sensor2value (SensorDataValue *_output_sensorDataValue) {
	...
	_output_sensorDataValue->resvCnt = 0;
...
int32_t MoveGpsData_value2packet (SensorDataValue *sensorDataValue, SensorDataPacket *_output_sensorDataPacket) {
	...
	tmpf = sensorDataValue->gpsSpeed;
	tmp32 = htonl(*(int32_t*)&tmpf);
	_output_sensorDataPacket->gpsSpeed	= *((float*)&tmp32);

	_output_sensorDataPacket->gpsHeading = (int16_t)sensorDataValue->gpsHeading;
	_output_sensorDataPacket->gpsHeading = htons(_output_sensorDataPacket->gpsHeading);
...
int32_t MoveOBD2Data_value2packet (SensorDataValue *sensorDataValue, SensorDataPacket *_output_sensorDataPacket) {
	...
	_output_sensorDataPacket->driverCode = sensorDataValue->driverCode;
	_output_sensorDataPacket->driverCode = htonl(_output_sensorDataPacket->driverCode);

	_output_sensorDataPacket->busDirection[0] = sensorDataValue->busDirection;
	
	_output_sensorDataPacket->busCntTime[0] = sensorDataValue->busCntTime;

	_output_sensorDataPacket->busSpeed[0]		= sensorDataValue->busSpeed;
	...
	_output_sensorDataPacket->busInnerOxygen[1]				= (BYTE)((BYTE) read_pcf8591_for_gas (&tmp));
	 

	_output_sensorDataPacket->runTimeToEngineStart		= (int16_t)sensorDataValue->runTimeToEngineStart;
	_output_sensorDataPacket->runTimeToEngineStart		= htons(_output_sensorDataPacket->runTimeToEngineStart);

	_output_sensorDataPacket->absoluteBarometricPressure[0]		= sensorDataValue->absoluteBarometricPressure;
	_output_sensorDataPacket->fuelTankLevelInput[0]		= sensorDataValue->fuelTankLevelInput;
	...
	movedDataSize = sizeof (_output_sensorDataPacket->obdTime)
		+ sizeof (_output_sensorDataPacket->driverCode)
		+ sizeof (_output_sensorDataPacket->busDirection)
		+ sizeof (_output_sensorDataPacket->busCntTime)
...
int32_t MoveUsrCntData_value2packet (SensorDataValue *sensorDataValue, SensorDataPacket *_output_sensorDataPacket) {
	...
	_output_sensorDataPacket->usrCnt		= (int16_t)_output_sensorDataPacket->usrCnt;
	_output_sensorDataPacket->usrCnt		= htons(sensorDataValue->usrCnt);

	_output_sensorDataPacket->oldUsrCnt		= (int16_t)_output_sensorDataPacket->oldUsrCnt;
	_output_sensorDataPacket->oldUsrCnt		= htons(sensorDataValue->oldUsrCnt);
...
int32_t MoveHygrothermalData_value2packet (SensorDataValue *sensorDataValue, SensorDataPacket *_output_sensorDataPacket) {
	...
	_output_sensorDataPacket->hygrometerHumidity[0]		= sensorDataValue->hygrometerHumidity;
...
int32_t MoveDisabledPersonResvData_value2packet (SensorDataValue *sensorDataValue, SensorDataPacket *_output_sensorDataPacket) {
	...
	_output_sensorDataPacket->resvCnt[0] = sensorDataValue->resvCnt;
	...
	movedDataSize = sizeof (_output_sensorDataPacket->disabledPersonResvTime)
		+ sizeof (_output_sensorDataPacket->resvCnt)
...
int32_t MoveGpsData_packet2buff (SensorDataPacket *sensorDataPacket, BYTE *_output_buff, int32_t *insertionLocation) {
	...
	MoveData_byte2buff ((BYTE*)&sensorDataPacket->gpsHeading,					2	, _output_buff, insertionLocation);
...
int32_t MoveOBD2Data_packet2buff (SensorDataPacket *sensorDataPacket, BYTE *_output_buff, int32_t *insertionLocation) {
	...
	MoveData_byte2buff ((BYTE*)&sensorDataPacket->driverCode,					4 , _output_buff, insertionLocation);
	MoveData_byte2buff (sensorDataPacket->busDirection,						1 , _output_buff, insertionLocation);
	MoveData_byte2buff (sensorDataPacket->busCntTime,						1	, _output_buff, insertionLocation);
	MoveData_byte2buff (sensorDataPacket->busSpeed,								1	, _output_buff, insertionLocation);
	MoveData_byte2buff (sensorDataPacket->busInnerOxygen,						2	, _output_buff, insertionLocation);
	MoveData_byte2buff ((BYTE*)&sensorDataPacket->runTimeToEngineStart,			2	, _output_buff, insertionLocation);
	MoveData_byte2buff (sensorDataPacket->absoluteBarometricPressure,			1	, _output_buff, insertionLocation);
	MoveData_byte2buff (sensorDataPacket->fuelTankLevelInput,					1	, _output_buff, insertionLocation);
...
int32_t MoveUsrCntData_packet2buff (SensorDataPacket *sensorDataPacket, BYTE *_output_buff, int32_t *insertionLocation) {
	...
	MoveData_byte2buff ((BYTE*)&sensorDataPacket->usrCnt,						2	, _output_buff, insertionLocation);
	MoveData_byte2buff ((BYTE*)&sensorDataPacket->oldUsrCnt,					2	, _output_buff, insertionLocation);
...
int32_t MoveHygrothermalData_packet2buff (SensorDataPacket *sensorDataPacket, BYTE *_output_buff, int32_t *insertionLocation) {
	...
	MoveData_byte2buff (sensorDataPacket->hygrometerHumidity,					1	, _output_buff, insertionLocation);
...
int32_t MoveDisabledPersonResvData_packet2buff (SensorDataPacket *sensorDataPacket, BYTE *_output_buff, int32_t *insertionLocation) {
	...
	MoveData_byte2buff (sensorDataPacket->resvCnt,										1	, _output_buff, insertionLocation);
...
int32_t MoveGpsData_buff2value (BYTE *buff, int32_t *insertionLocation, SensorDataValue *_output_sensorDataValue) {
	...
	//ntohl를 사용하기 위하여, float변수를 정수형 구조로 읽습니다.
	tmp32 = *(int32_t*)&_output_sensorDataValue->gpsSpeed;
	tmp32 = ntohl(tmp32);
	//호스트 바이트로 변환한 바이트를, 다시 float형 구조로 읽습니다.
	_output_sensorDataValue->gpsSpeed = *((float*)&tmp32);
	
	MoveData_buff2byte (buff, insertionLocation, (BYTE*)&_output_sensorDataValue->gpsHeading, 2);
	_output_sensorDataValue->gpsHeading = ntohs(_output_sensorDataValue->gpsHeading);
...
float ftmp = 0.0f;
	...
	MoveData_buff2byte (buff, insertionLocation, (BYTE*)&_output_sensorDataValue->driverCode,					4);
	_output_sensorDataValue->driverCode = ntohl(_output_sensorDataValue->driverCode);
	
	MoveData_buff2byte (buff, insertionLocation, (BYTE*)&_output_sensorDataValue->busDirection,					1);
	
	MoveData_buff2byte (buff, insertionLocation, (BYTE*)&_output_sensorDataValue->busCntTime,					1);

	MoveData_buff2byte (buff, insertionLocation, (BYTE*)&_output_sensorDataValue->busSpeed , 1);
	...
	MoveData_buff2byte (buff, insertionLocation, (BYTE*)&_output_sensorDataValue->runTimeToEngineStart, 2);
	_output_sensorDataValue->runTimeToEngineStart		= ntohs(_output_sensorDataValue->runTimeToEngineStart);

	MoveData_buff2byte (buff, insertionLocation, (BYTE*)&_output_sensorDataValue->absoluteBarometricPressure, 1);

	MoveData_buff2byte (buff, insertionLocation,(BYTE*)& _output_sensorDataValue->fuelTankLevelInput, 1);

	_output_sensorDataValue->engineRPM					= (buff[(*insertionLocation)]<<8 | (buff[(*insertionLocation)+1])) * 0.25f;
	(*insertionLocation)++;
	(*insertionLocation)++;
...
int32_t MoveUsrCntData_buff2value (BYTE *buff, int32_t *insertionLocation, SensorDataValue *_output_sensorDataValue) {
	...
	MoveData_buff2byte (buff, insertionLocation, (BYTE*)&_output_sensorDataValue->usrCnt, 2);
	_output_sensorDataValue->usrCnt		= ntohs(_output_sensorDataValue->usrCnt);
	MoveData_buff2byte (buff, insertionLocation, (BYTE*)&_output_sensorDataValue->oldUsrCnt, 2);
	_output_sensorDataValue->oldUsrCnt	= ntohs(_output_sensorDataValue->oldUsrCnt);
...
int32_t MoveHygrothermalData_buff2value (BYTE *buff, int32_t *insertionLocation, SensorDataValue *_output_sensorDataValue) {
	...
	MoveData_buff2byte (buff, insertionLocation, (BYTE*)&_output_sensorDataValue->hygrometerHumidity, 1);
...
int32_t MoveDisabledPersonResvData_buff2value (BYTE *buff, int32_t *insertionLocation, SensorDataValue *_output_sensorDataValue) {
	...
	MoveData_buff2byte (buff, insertionLocation, &_output_sensorDataValue->resvCnt,								1);
...
void PrintSensorDataValue (SensorDataValue *sensorDataValue) {
	...
	*/
	...
	printf		("                DriverCode:: %x\n", sensorDataValue->driverCode);
	printf		("              busDirection:: %d\n", sensorDataValue->busDirection);
	printf		("                busCntTime:: %d\n", sensorDataValue->busCntTime);
	...
	printf		("disabledPersonResvReserved:: ");
	for (i = 0; i < 10; i++)
		printf("%c", sensorDataValue->disabledPersonResvReserved[i]);
	printf("\n");
	printf		("\n");
