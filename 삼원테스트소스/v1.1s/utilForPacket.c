...
char	temp[16] = {0, };
	...
	_output_sensorDataValue->runTimeToEngineStart = (buff2int[0]<<8) + buff2int[1];//*(int*)buff2int;

	buff2int[0] = buff[g_recvBuffInsertionLocation++];
	buff2int[1] = buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->engineRPM = (buff2int[0]*256 + buff2int[1])/4.0f;//(*(int*)buff2int)/4.0f;
...
int32_t GetDataFromRecvBuff (BYTE buff[SEND_BUFF_MAX_LENGTH], SensorDataValue *_output_sensorDataValue) {
	...
	_output_sensorDataValue->control_stx[0] = buff[g_recvBuffInsertionLocation++];

	_output_sensorDataValue->serialId[0] = buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->serialId[1] = buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->serialId[2] = buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->serialId[3] = buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->serialId[4] = buff[g_recvBuffInsertionLocation++];

	_output_sensorDataValue->terminalId[0] = buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->terminalId[1] = buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->terminalId[2] = buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->terminalId[3] = buff[g_recvBuffInsertionLocation++];

	_output_sensorDataValue->responseCode[0]= buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->errorCode[0]	= buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->commandCode[0] = buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->seqNo[0]		= buff[g_recvBuffInsertionLocation++];
	...
	GetGpsData_buff2value						(buff, _output_sensorDataValue);
	GetThermometerData_buff2value				(buff, _output_sensorDataValue);
	GetCoolerData_buff2value					(buff, _output_sensorDataValue);
	GetUsersData_buff2value						(buff, _output_sensorDataValue);
	GetHygrometerData_buff2value				(buff, _output_sensorDataValue);
	GetPanicButtonData_buff2value				(buff, _output_sensorDataValue);
	GetDisabledPersonReservationData_buff2value	(buff, _output_sensorDataValue);
	GetWildDrivingData_buff2value				(buff, _output_sensorDataValue);
	GetGSensorData_buff2value					(buff, _output_sensorDataValue);
	GetOBD2Data_buff2value						(buff, _output_sensorDataValue);
	GetBeaconData_buff2value					(buff, _output_sensorDataValue);
	GetSpeakerData_buff2value					(buff, _output_sensorDataValue);
	GetIoData_buff2value						(buff, _output_sensorDataValue);
	GetImageData_buff2value						(buff, _output_sensorDataValue);

	_output_sensorDataValue->errorCheck[0]	= buff[g_recvBuffInsertionLocation++];
	_output_sensorDataValue->control_etx[0]	= buff[g_recvBuffInsertionLocation++];
