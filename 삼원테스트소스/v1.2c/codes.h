...
#define COMMAND_CODE_START_DRIVING				(BYTE)0x21
#define COMMAND_CODE_STOP_DRIVING				(BYTE)0x22
#define	COMMAND_CODE_SEND_SENSOR_DATA			(BYTE)0x23
#define	COMMAND_CODE_EVENT						(BYTE)0x24
#define COMMAND_CODE_TBD						(BYTE)0x25
